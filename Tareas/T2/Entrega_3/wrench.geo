...
//+
Physical Surface("Handle1", 124) = {27};
//+
Physical Surface("Handle2", 125) = {28};
//+
Coherence;
//+
Physical Curve("NaturalBoundary1", 128) += {112, 111, 109, 125, 127, 124, 105, 106, 108, 120, 121, 122, 118};
//+
Physical Curve("NaturalBoundary2", 129) = {119};
//+
Physical Curve("EssentialBoundary", 130) = {126, 123};
